...
jpeg("figures/spatial_urban.jpeg", 3.25, height = 2.5, units = "in", quality = 100, res = 300)
print(space_urban)
dev.off()
...
jpeg("figures/spatial_rural.jpeg", 3.25, height = 2.5, units = "in", quality = 100, res = 300)
print(space_rural)
dev.off()
...
```{r stats_table, echo = FALSE, warning = FALSE, message = FALSE}
...
colnames(noise_stats) <- c('Noise Variation','Data','Variable', 'Chi-Squared', 'N', 'P-Value', 'Cond. R²', 'Marg. R²')

flextable(noise_stats[ , 1:8]) %>% 
  autofit() %>% 
  merge_v(j = c('Noise Variation', 'Data', 'Cond. R²', 'Marg. R²'), part = "body") %>% 
